      ...
      <div className="p-6 flex gap-6">
        <div className="flex flex-col flex-1 space-y-6">
          ...
          <div className="flex flex-col w-[550px]">
            ...
            <div className="bg-white h-70 p-4 shadow flex flex-col items-center justify-center">
              <div className="bg-blue-800 w-10 h-10 rounded"></div>
              <div className="text-black font-normal mt-2">JURNAL MENGAJAR</div>
              <div className="bg-blue-800 w-10 h-10 rounded"></div>
              <div className="text-black font-normal mt-2">NILAI</div>
              <div className="bg-blue-800 w-10 h-10 rounded"></div>
              <div className="text-black font-normal mt-2">AKADEMIK</div>
            </div>
          ...
          <div className="flex flex-col flex-1 ml-4">
            ...
            <div className="bg-white shadow rounded-b-lg flex-1 flex flex-col p-4">
              <div className="flex-1 flex flex-col space-y-3 overflow-y-auto pr-2">
                <div className="bg-gray-200 rounded-lg h-14">
                ...
                <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Qismat Rajjab</div>
                  <div className="font-normal text-gray-700 text-xs mt-1">fokus mki mengajar pak</div>
                </div>
                <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Ahmad Rezky Permana</div>
                  <div className="font-normal text-gray-700 text-xs mt-1">Adakah Seratus?</div>
                </div>
                <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Qismat Rajjab</div>
                ...
                <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Daniel Abraham</div>
                  <div className="font-normal text-gray-700 text-xs mt-1">Adakah Seratus?</div>
                </div>
                <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Qismat Rajjab</div>
                  <div className="font-normal text-gray-700 text-xs mt-1">Ambil ki nanti SP 3 ta semua ki</div>
                </div>
                 <div className="bg-gray-200 rounded-lg h-14">
                  <div className="font-bold text-gray-800 text-sm">Mr.Daniel Abraham</div>
                  <div className="font-normal text-gray-700 text-xs mt-1">lah? Bangke </div>
                </div>
              </div>
              <div className="mt-3 flex items-center">
                ...
                />
                <button className="ml-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full shadow transition">
                  =
                </button>
              </div>
